...
| `publishable docs` | built | *(none)* | Regenerates every `publishable:begin/end` managed region |
| `publishable list-templates` | built | *(none)* | Registered templates, including plugin-provided, with their full parameter specs |
